...
(function () {
  ...
  const translations = {
    el: {
      ...
      'experience.p3': 'Σπιτική τάρτα, φρέσκα αυγά, μαρμελάδα, φρούτα   ετοιμάζουμε το welcome package με αγάπη.',
      'experience.h4': 'Προσωπική Φροντίδα',
      'experience.p4': 'Pickup από το λιμάνι, tips για το νησί, πετσέτες παραλίας   σκεφτόμαστε τα πάντα για εσάς.',
      ...
      'info.pickup': 'Δωρεάν pickup από το λιμάνι   σας περιμένουμε στην άφιξη!',
      ...
      'contact.desc': 'Στείλτε μας μήνυμα ή καλέστε μας   θα χαρούμε να απαντήσουμε σε κάθε ερώτησή σας.',
      ...
      'contact.anna_text': 'Απαντάμε προσωπικά σε κάθε μήνυμα. Μη διστάσετε να ρωτήσετε οτιδήποτε!',
    ...
    en: {
      ...
      'experience.p3': 'Homemade tart, fresh eggs, jam, fruits   we prepare the welcome package with love.',
      'experience.h4': 'Personal Care',
      'experience.p4': 'Port pickup, island tips, beach towels   we think of everything for you.',
      ...
      'info.pickup_title': 'Pickup',
      'info.pickup': 'Free port pickup   we will be waiting for you on arrival!',
      'faq.tag': 'FAQ',
      ...
      'contact.desc': 'Send us a message or give us a call   we\'ll be happy to answer any question you may have.',
      ...
      'contact.phone': 'Phone',
      'contact.anna_text': 'We personally reply to every message. Don\'t hesitate to ask anything!',
    ...
    it: {
      ...
      'experience.p3': 'Crostata fatta in casa, uova fresche, marmellata, frutta   prepariamo il welcome package con amore.',
      'experience.h4': 'Cura Personale',
      'experience.p4': 'Pickup dal porto, consigli sull\'isola, asciugamani da spiaggia   pensiamo a tutto per voi.',
      ...
      'info.pickup_title': 'Pickup',
      'info.pickup': 'Pickup gratuito dal porto   vi aspettiamo al vostro arrivo!',
      ...
      'contact.desc': 'Inviateci un messaggio o chiamateci   saremo felici di rispondere a qualsiasi vostra domanda.',
      ...
      'contact.anna_text': 'Rispondiamo personalmente a ogni messaggio. Non esitate a chiedere qualsiasi cosa!',
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      var successMessages = {
        el: { title: 'Ευχαριστούμε!', text: 'Το μήνυμά σας ετοιμάστηκε. Θα απαντήσουμε σύντομα!' },
        en: { title: 'Thank you!', text: 'Your message has been prepared. We will reply shortly!' },
        it: { title: 'Grazie!', text: 'Il vostro messaggio è stato preparato. Risponderemo presto!' }
      };
